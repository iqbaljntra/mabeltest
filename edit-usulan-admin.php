...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script>alert('Usulan berhasil diperbarui!'); window.location.href='data-user.php?user_id=';</script>";
}
        ...
        <div id="items-container">
            <?php foreach ($produk_data as $i => $produk): ?>
                <div class="item">
                    ...
                    <label>Referensi Ekatalog:</label>
                    <input type="text" name="referensi_ekatalog[]" readonly="<?= htmlspecialchars($produk['referensi_ekatalog']) ?>">
